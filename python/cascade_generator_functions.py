...
"""
Sampling utilities and generator functions to create cascades and place them into the I3MCTree. Needs to be used inside of the IceCube icetray software project.
